...
/* Macro to check if a line is a comment line (starts with ';') */
#define isCommentLine(x) (((x)[0])== ';') 

/* Number of commands possible */
#define NUM_OF_COMMANDS 16 

/* Number of directives possible */
#define NUM_OF_DIRECTIVES 4  

/* All the commands names */
char* COMMAND_STRING[NUM_OF_COMMANDS]={"mov","cmp","add","sub","not","clr","lea","inc","dec","jmp","bne","red","prn","jsr","rts","stop"}; 

/* All the directives names */
