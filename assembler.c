...
{
    int flag_to_return=TRUE; /*flag if AssemblerActivate() function succeed, what means if the first and the second pass succeed*/
    int flag_of_error; /*flag to check if there are errors*/

    int new_IC=INITIAL_IC; /*Instruction counter variable for the given file*/
    int new_DC=INITIAL_DC; /*Data counter variable for the given file*/
